{----------------------------------------------------------------------------------
/
/      filename:  tinymachine.idr
/
/   description:  Shows the development and proofing of a toy language. Useful for
/					seeing how the formal proofing of Idris can be used in some
/					applications.
/
/        author:  mbrodersen, retrieved from 
